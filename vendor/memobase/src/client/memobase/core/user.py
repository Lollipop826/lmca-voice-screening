...
class EventData(BaseModel):
    ...
    turn_id: Optional[str] = Field(None, description="Source turn ID")
    source_turn_id: Optional[str] = Field(None, description="Source local turn ID")
...
class UserEventGistData(BaseModel):
    ...
    event_id: Optional[UUID4 | UUID5] = Field(None, description="Source event ID")
